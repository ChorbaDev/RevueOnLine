...
public class MySQLRevueDAO implements RevueDAO {
    ...
    public ArrayList<Revue> getByTitre(String titre) throws SQLException {
        ...
        while (res.next()) {
            list.add(new Revue(res.getInt(1), res.getString(2), res.getString(3), res.getDouble(4), res.getString(5), res.getInt(6)));
        }
